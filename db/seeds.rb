...
comment1 = Comment.create({photo_id: photo11.id, author_id: user2.id, body: "Wow nice picture!"})
comment2 = Comment.create({photo_id: photo11.id, author_id: user3.id, body: "Coooooool!"})
comment3 = Comment.create({photo_id: photo11.id, author_id: user4.id, body: "How did you take this picture?"})
comment4 = Comment.create({photo_id: photo11.id, author_id: user5.id, body: "So nice!"})
comment5 = Comment.create({photo_id: photo11.id, author_id: user6.id, body: "Wowza"})
comment6 = Comment.create({photo_id: photo12.id, author_id: user1.id, body: "I like this!"})
comment7 = Comment.create({photo_id: photo12.id, author_id: user3.id, body: "Great picture!"})
comment8 = Comment.create({photo_id: photo12.id, author_id: user4.id, body: "Amazing"})
comment9 = Comment.create({photo_id: photo12.id, author_id: user5.id, body: "Woah"})
comment10 = Comment.create({photo_id: photo12.id, author_id: user6.id, body: "Where is this?!"})
comment11 = Comment.create({photo_id: photo13.id, author_id: user6.id, body: "Wow!!!"})
comment12 = Comment.create({photo_id: photo13.id, author_id: user3.id, body: "Awesome!!!"})
